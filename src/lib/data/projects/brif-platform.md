...
stats:
  ...
  - key: 'User Engagement'
    value: '+18%'
    description: 'Increase from performance improvements'
  - key: 'Build Time'
    value: '7 min'
    description: 'Automated CI/CD deployment pipeline'
gallery:
  - '/portfolio/brif-website.png'
---
...
<p>Performance was a key focus. When I started, the site had room for improvement on Core Web Vitals, particularly Largest Contentful Paint. Through image optimization, code splitting, and strategic caching, I brought LCP down by 35%. That translated directly to an 18% boost in user engagement—faster pages mean more people actually reading the articles and watching the videos.</p>
