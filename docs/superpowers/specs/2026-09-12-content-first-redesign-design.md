...
- 2025–present SusuPaa. Co-founded and led the platform: custom append-only ledger with strict consistency guarantees, 339 organizations, 28 API modules in production. Cut p99 latency from 1.6s to 500ms.
